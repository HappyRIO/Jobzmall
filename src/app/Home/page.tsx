          ...
          <div className="md:grid md:grid-cols-8 px-8 gap-8">
            <div className="flex flex-col relative md:col-span-3 lg:col-span-2">
              <div className="hidden md:flex md:flex-col items-center bg-white mt-[44px] rounded-xl">
                ...
                <div className="flex flex-col px-4 pb-4 pt-2 items-center space-y-4">
                  <div className="text-[#252525] font-bold text-2xl ">Yoshito User</div>
                  <div className="flex p-4 border-l-4 border-[#9333EA] rounded-[4px] shadow-md">
                    <div className=""><CheckCircleIcon sx={{color: "#9333EA", height: "19.21px", width: "19.21px"}}/></div>
                    <div className="flex flex-col pl-4">
                      <div className="text-[#9333EA] text-sm">Fill your Profile</div>
                      <div className="text-[#525252] text-sm mt-1">Incomplete profiles may result in limited visibility and opportunities</div>
                    </div>
                </div>
                </div>
            ...
            <div className="lg:flex flex-col lg:col-span-2 hidden space-y-4">
              <div className="flex flex-col p-6 bg-white rounded-xl">
                <div className="text-[#262626] font-medium text-sm">My resumes</div>
                <div className="flex flex-col items-center px-8 py-6 pb-0">
                  <div className="flex items-center justify-center rounded-full flex-0 w-14 h-14 bg-gray-200"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" className="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 0 0-1.883 2.542l.857 6a2.25 2.25 0 0 0 2.227 1.932H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-1.883-2.542m-16.5 0V6A2.25 2.25 0 0 1 6 3.75h3.879a1.5 1.5 0 0 1 1.06.44l2.122 2.12a1.5 1.5 0 0 0 1.06.44H18A2.25 2.25 0 0 1 20.25 9v.776" className="ng-tns-c419-623"></path></svg></div>
                  <div className="mt-5 text-[#262626] text-xl font-semibold text-nowrap">No resumes</div>
                  <div className="w-full mt-1 text-[#737373] text-center max-w-60 text-[13px]">When you have resumes, they will appear here.</div>
                </div>
                <div className="mt-6"><a className="block w-full px-4 py-2 text-xs font-medium text-center border border-gray-300 rounded-md shadow-sm text-[#737373] hover:bg-gray-50" href="/my-resumes"> Upload Resume </a></div>
              </div>
              <div className="flex flex-col p-6 bg-white rounded-xl">
                <div className="text-[#262626] font-medium text-sm">My Applications</div>
                <div className="flex flex-col items-center px-8 py-6 pb-0">
                  <div className="flex items-center justify-center rounded-full flex-0 w-14 h-14 bg-gray-200"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="black" className="w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 0 0-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0 1 12 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 0 1-.673-.38m0 0A2.18 2.18 0 0 1 3 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 0 1 3.413-.387m7.5 0V5.25A2.25 2.25 0 0 0 13.5 3h-3a2.25 2.25 0 0 0-2.25 2.25v.894m7.5 0a48.667 48.667 0 0 0-7.5 0M12 12.75h.008v.008H12v-.008Z" className="ng-tns-c328-17"></path></svg></div>
