...
const JobModal: React.FC<PropsType> = ({setIsClose}) => {
  ...
  return (
    <>
      <div className="absolute flex top-0 w-full 1h-full">
        <div className="absolute bg-black w-full h-full opacity-80"></div>
        <div className="absolute right-10 top-10 z-10 bg-white rounded-full cursor-pointer" onClick={handlemodal}><CloseOutlinedIcon className="text-2xl m-2 text-gray-600"/></div>
          ...
          <div className="flex flex-col z-10 bg-white max-w-[768px] justify-centeroverflow-y-auto rounded-xl">
            <div className="relative bg-black rounded-xl">
                <div className="absolute flex flex-col h-full right-4 items-center justify-center gap-4">
                    <PauseIcon className="text-white rounded-full hover:bg-gray-50 hover:bg-opacity-10 p-1 cursor-pointer z-10" fontSize="large"/>
                    <VolumeUpIcon className="text-white rounded-full hover:bg-gray-50 hover:bg-opacity-10 p-1 cursor-pointer z-10" fontSize="large"/>
                </div>
                <div className="absolute flex w-full bottom-4 items-center justify-end gap-4">
                    <ArrowBackIosIcon className="text-white rounded-full hover:bg-gray-50 hover:bg-opacity-10 p-1 pl-2 cursor-pointer z-10" fontSize="large"/>
                    <ArrowForwardIosIcon className="text-white rounded-full hover:bg-gray-50 hover:bg-opacity-10 p-1 pr-2 cursor-pointer z-10" fontSize="large"/>
                </div>
                <div className="absolute top-2 left-4 z-10 line-clamp-2 text-white text-sm">About City of Jersey City</div>
            ...
            <div className="flex-col px-4 pb-12">
              ...
              <div className="flex flex-col mt-5 text-[#262626]">
                <div className="mb-3 text-lg font-semibold">Where is this job?</div>
                <div className="pb-8 text-sm">This job is located at Jersey City, NJ, USA</div>
              ...
              <div className="flex flex-col mt-5 text-[#262626]">
                <div className="mb-3 text-lg font-semibold"></div>
              ...
              <div className="flex rounded-xl bg-[#EFF6FF] p-5">
                ...
                <div className="text-[#1D4ED8] text-sm pl-4">
                  ...
                  City of Jersey City is an Equal Opportunity
                  Employer. We celebrate diversity and are committed to creating
                  an inclusive environment for all employees. We do not
                  discriminate based upon race, religion, color, national
                  origin, sex, sexual orientation, gender identity, age, status
                ...
                <div className="flex flex-col mt-5 text-[#262626]">
                    <div className="mb-3 text-lg font-semibold ">Additional Information</div>
                    <div className="flex flex-row mb-2">
                        <TranslateRoundedIcon className="text-gray-500" fontSize="small"/>
                        <div className="mr-1 font-semibold text-sm pl-2">Required Languages</div>
                        <div className="text-sm">English</div>
                    </div>
                    <div className="flex flex-row mb-2">
                        <AccessTimeFilledIcon className="text-gray-500" fontSize="small"/>
                        <div className="mr-1 font-semibold text-sm pl-2">Job Posted</div>
                        <div className="text-sm">September 13th, 2024</div>
                    </div>
                    <div className="flex flex-row mb-2">
                        <WorkHistoryRoundedIcon className="text-gray-500" fontSize="small"/>
                        <div className="mr-1 font-semibold text-sm pl-2">Apply Before</div>
                        <div className="text-sm">October 12th, 2024</div>
                    </div>
                    <div className="flex flex-row mb-2 text-[#262626]">
                        <VerifiedRoundedIcon className="text-gray-500" fontSize="small"/>
                        <div className="mr-1 font-semibold text-sm pl-2">This is a verified job listing.</div>
