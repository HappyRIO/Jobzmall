...
export default function Header() {
  ...
  return (
    <>
      <div className="flex justify-between items-center mx-auto 1md:block pl-16 px-8 h-[76px] gap-8">
        <div className="w-[500px]1 1h-10">
          <Image className="w-[500px] h-10" src={"/logo.png"} alt="" width={108} height={40} />
        </div>
